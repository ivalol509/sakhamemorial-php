...
<body>
	<div class="mx-auto bg-white" style="width: 100%">
			<div class="row">
				<div class="colp text-center d-flex" style="margin-left: 25vh;">
					<a href="index1.php" style="display: flex; text-decoration: none; color: black;"><img src="logo.png" style="height: 60px; width: 60px; margin-left: 9px; margin-top: 20px;">
					<h1 style="font-family: Orbitron; margin-left: 1vh; margin-right: 30vh;" class="mt-4 mb-4">SakhaMemorial</h1></a>
					<div style="display: flex;">
						...
						<a href="poisk.php" style="text-decoration: none; display: flex; width: 17vh; margin-left: 7vh;">
						...
						<a href="utilites/delete.php" style="text-decoration: none; display: flex; width: 22vh; margin-left: 7vh;">
							<img src="icon/vihod.png" style="height: 5vh; margin-top: 5.8vh; width: 5vh;">
							<h5 style="color: black; margin-top: 5.8vh; margin-left: 1.5vh;">Выход</h5>
						</a>
					</div>
				</div>
				<?php 
					$q = mysqli_query($c, "SELECT * FROM author WHERE id='{$_SESSION['user']}'");
					$s = $q->fetch_assoc();
				?>
				<p style="text-align: center; font-size: 6vh;" class="mt-2">Привет, <?php echo $s["name"] ?>!</p>
				<p style="text-align: center; font-size: 5vh;" class="mt-2">Памятники, которые добавили Вы</p>
				<?php 
					$q = mysqli_query($c, "SELECT * FROM p WHERE author='{$_SESSION['user']}' AND sost=0");
					if (mysqli_num_rows($q)==0) {
				?>
						<div style="height: 70vh; width: 100%; display: flex; justify-content: center;" class="mt-2">
							<img src="https://i.pinimg.com/originals/e5/93/ab/e593ab0589d5f1b389e4dfbcce2bce20.gif">
							<h5 style="position: absolute; top: 40vh;">Похоже, тут только БиМО</h5>
						</div>
				<?php
					} else{
					for ($i=0; $i < mysqli_num_rows($q); $i++) { 
